...
export class SesionesPage implements OnInit {
  ...
  constructor(private renderer2:Renderer2,private forms: FormBuilder,private router:Router,private autenticador:AutenticacionService, private spinner:NgxSpinnerService)
  {
  ...
  public mostrarError(error:string)
  {
    ...
    if (this.email == "")
    {
      this.mensajeError = "El campo email está vacio. Por favor ingrese su mail";
    }
  }
